...
class CreatePersonalContractsTable extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::connection($connection)->hasTable('personal_contracts')) {
            Schema::connection($connection)->create('personal_contracts', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        if ($main && Schema::connection($connection)->hasTable('personal_contracts')) {
            Schema::connection($connection)->dropIfExists('personal_contracts');
        }
    }
}
